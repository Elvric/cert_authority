...
sudo iptables -A FORWARD -p tcp -s 172.27.0.2 -d 172.26.0.2 -j ACCEPT
sudo iptables -A FORWARD -p tcp -s 172.27.0.0/24 --dport 22 -j ACCEPT
sudo iptables -A FORWARD -p tcp --dport 22 -j ACCEPT
sudo iptables -A FORWARD -s 172.26.0.2 -d 172.27.0.2 -p tcp --dport 443 -j ACCEPT
