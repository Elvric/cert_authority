...
openssl pkcs12 -export -in ./certificates/client.pem -inkey ./certificates/client.key -out ./certificates/$1_$2.p12 -password pass:pass
rm ./certificates/client.key
rm ./certificates/client.pem